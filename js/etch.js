...
let width = Math.round(canvasWidth / numberOfSquares);
let height = Math.round(canvasWidth / numberOfSquares);
let rainbow = 0;
console.log("arriba");
...
range.addEventListener("input", () => {
    ...
    numberOfSquares = parseInt(range.value);
    width = Math.round(canvasWidth / numberOfSquares);
    height = Math.round(canvasWidth / numberOfSquares);
    canvas.innerHTML = "";
    createCanvas();
});